...
export const EducationIcon: FC<ContentIconSetProps> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'Book':
      return <BookIcon iconSize={iconSize} />;
    case 'BookFill':
      return <BookFillIcon iconSize={iconSize} />;
    case 'Journal':
      return <JournalIcon iconSize={iconSize} />;
    case 'HatGraduate':
      return <HatGraduateIcon iconSize={iconSize} />;
    default:
      return null;
  }
};

const BookIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const BookFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const JournalIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HatGraduateIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
