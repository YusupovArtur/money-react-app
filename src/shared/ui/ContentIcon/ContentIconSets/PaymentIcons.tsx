...
export const PaymentIcons: FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'FileText':
      return <FileTextIcon iconSize={iconSize} />;
    case 'FileTextFill':
      return <FileTextFillIcon iconSize={iconSize} />;
    case 'Droplet':
      return <DropletIcon iconSize={iconSize} />;
    case 'Globe2':
      return <Globe2Icon iconSize={iconSize} />;
    case 'WIFI':
      return <WIFIIcon iconSize={iconSize} />;
    case 'RouterFill':
      return <RouterFillIcon iconSize={iconSize} />;
    case 'SIMFill':
      return <SIMFillIcon iconSize={iconSize} />;
    default:
      return null;
  }
};

const FileTextIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const FileTextFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const DropletIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const Globe2Icon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const WIFIIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const RouterFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const SIMFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
