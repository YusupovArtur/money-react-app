...
export const TransportIcons: FC<ContentIconSetProps> = ({ iconName, iconSize }) => {
  switch (iconName) {
    ...
    case 'CarFill':
      return <CarFillIcon iconSize={iconSize} />;
    case 'Parking':
      return <ParkingIcon iconSize={iconSize} />;
    case 'FuelPump':
      return <FuelPumpIcon iconSize={iconSize} />;
    case 'Bus':
      return <BusIcon iconSize={iconSize} />;
    case 'BusFill':
      return <BusFillIcon iconSize={iconSize} />;
    case 'Taxi':
      return <TaxiIcon iconSize={iconSize} />;
    case 'TruckFront':
      return <TruckFrontIcon iconSize={iconSize} />;
    case 'Truck':
      return <TruckIcon iconSize={iconSize} />;
    case 'Airplane':
      return <AirplaneIcon iconSize={iconSize} />;
    case 'AirplaneFill':
      return <AirplaneFillIcon iconSize={iconSize} />;
    case 'Train':
      return <TrainIcon iconSize={iconSize} />;
    case 'TrainFill':
      return <TrainFillIcon iconSize={iconSize} />;
    case 'Scooter':
      return <ScooterIcon iconSize={iconSize} />;
    case 'Bicycle':
      return <BicycleIcon iconSize={iconSize} />;
    default:
      return null;
  }
};

const CarIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const CarFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const FuelPumpIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const ParkingIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const BusIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const BusFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TaxiIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const AirplaneIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const AirplaneFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TrainIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TrainFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TruckIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TruckFrontIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const ScooterIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const BicycleIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
