...
export const RecreationIcons: FC<{ iconName: string; iconSize: `${number}rem` }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'MusicNote':
      return <MusicNoteIcon iconSize={iconSize} />;
    case 'Film':
      return <FilmIcon iconSize={iconSize} />;
    case 'Wine':
      return <WineIcon iconSize={iconSize} />;
    case 'Ticket':
      return <TicketIcon iconSize={iconSize} />;
    case 'TicketFill':
      return <TicketFillIcon iconSize={iconSize} />;
    case 'Suitcase':
      return <SuitcaseIcon iconSize={iconSize} />;
    case 'SuitcaseFill':
      return <SuitcaseFillIcon iconSize={iconSize} />;
    case 'Backpack':
      return <BackpackIcon iconSize={iconSize} />;
    case 'BackpackFill':
      return <BackpackFillIcon iconSize={iconSize} />;
    default:
      return null;
  }
};

const MusicNoteIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const FilmIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const WineIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
      ...
      xmlSpace="preserve"
    >
      <path d="M167.9,126.9c12-8.5,32.1-23.4,32.1-62.6c0-31.7-18.5-60-18.5-60H74.6c0,0-18.5,28.5-18.5,60.3c0,39.2,20.1,54.1,32,62.6 c13.8,9.8,34.8,28.5,34.8,31.4v78.6H75.9v13.4h102.9v-13.4h-45.7v-78.6C133.1,155.4,154.1,136.8,167.9,126.9z M81.8,14.6h92.5 c4.8,0,15.4,28.6,15.4,49.7c0,0.6,0,1.2,0,1.7H66.3c0-0.5,0-1,0-1.4C66.3,43.5,77,23,81.8,14.6z"></path>
    </svg>
  );
};

const TicketIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TicketFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const SuitcaseIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const SuitcaseFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const BackpackIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const BackpackFillIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
