...
export const GoodsIcons: FC<ContentIconSetProps> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'Cloth':
      return <ClothIcon iconSize={iconSize} />;
    case 'Shoes':
      return <ShoesIcon iconSize={iconSize} />;
    case 'Watch':
      return <WatchIcon iconSize={iconSize} />;
    default:
      return null;
  }
};

const ClothIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const ShoesIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
...
const WatchIcon: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
