...
import { setImage, drawImage, moveImage, rescaleImage, uploadImage } from 'components/pages/profile_page/functions';

import ModalContainer from 'components/small_components/ModalContainer';
import { CloudPlusSVG, CrossIconSVG } from 'components/small_components/icons_svg/IconsSVG';
