...
import CategoryInput from 'components/pages/categories_page/categories_form/CategoryInput';
import CategoriesList from 'components/pages/categories_page/categories_list/CategoriesList';
import CategoryOpened from 'components/pages/categories_page/categories_list/CategoryOpened';

import CategoriesFilter from 'components/pages/categories_page/CategoriesFilter';
