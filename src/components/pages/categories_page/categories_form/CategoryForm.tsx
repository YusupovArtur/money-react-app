...
// Import menus
import CategoryTypeMenu from 'components/pages/categories_page/categories_form/CategoryTypeMenu';
import IconMenu from 'components/small_components/dropdowns/IconMenu';
import { CATEGOTY_ICONS_FIELD } from 'components/small_components/icons_svg/icon_sets/ContentIconSets';
