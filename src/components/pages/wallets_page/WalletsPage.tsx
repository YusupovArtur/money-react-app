...
// Wallet components
import { ArrowLeftRightIconSVG, PlusIconSVG } from 'components/small_components/icons_svg/IconsSVG';
import WalletInput from 'components/pages/wallets_page/wallet_form/WalletInput';
import WalletsList from 'components/pages/wallets_page/wallets_list/WalletsList';
// Transaction components
import TransactionInput from 'components/pages/transactions_page/transaction_form/TransactionInput';

function WalletsPage(): React.ReactElement {
