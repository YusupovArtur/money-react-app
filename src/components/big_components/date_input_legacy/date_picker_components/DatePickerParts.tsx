...
import { getMobileDatePickersLabel } from 'components/big_components/date_input_legacy/functions';
import { ChevrontRightIconSVG, ChevronLeftIconSVG } from 'components/small_components/icons_svg/IconsSVG';
import { DATE_PICKER_CELL_SIZE, MONTH_ABBREVIATED_NAMES } from 'components/big_components/date_input_legacy/constants';
