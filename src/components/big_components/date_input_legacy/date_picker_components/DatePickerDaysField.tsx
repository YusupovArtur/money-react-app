...
import { getDatePickerNewValue } from 'components/big_components/date_input_legacy/functions';
import { DATE_PICKER_CELL_SIZE, DAY_SHORT_NAMES } from 'components/big_components/date_input_legacy/constants';
