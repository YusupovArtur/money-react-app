...
import { datePickerYearCellPropsType } from 'components/big_components/date_input_legacy/types';
import { DATE_PICKER_CELL_SIZE, MIN_YEAR, MAX_YEAR } from 'components/big_components/date_input_legacy/constants';

const DatepickerYearCell: React.FC<{
...
const DatepickerYearsField: React.FC<{
  setCurrentYear: React.Dispatch<React.SetStateAction<number>>;
  setDisplayedField: React.Dispatch<React.SetStateAction<'day' | 'month' | 'year'>>;
  currentYear: number;
