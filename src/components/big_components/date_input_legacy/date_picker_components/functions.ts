import { MIN_YEAR, MAX_YEAR } from 'components/big_components/date_input_legacy/constants';
import { datePickerDayCellPropsType } from 'components/big_components/date_input_legacy/types';
import { getIsDateCorrect } from 'components/big_components/date_input_legacy/functions';
...
export const getDatePickerDaysField = (
  ...
  const dateInputsTimestamps = getDateInputTimestamps(dateInputsValue);
