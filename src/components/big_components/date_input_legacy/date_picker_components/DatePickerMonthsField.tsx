...
import { datePickerMonthCellPropsType } from 'components/big_components/date_input_legacy/types';
import { DATE_PICKER_CELL_SIZE, MONTH_SHORT_NAMES } from 'components/big_components/date_input_legacy/constants';

const DatePickerMonthCell: React.FC<{
...
const DatePickerMonthsField: React.FC<{
  setCurrentMonth: React.Dispatch<React.SetStateAction<number>>;
  setDisplayedField: React.Dispatch<React.SetStateAction<'day' | 'month' | 'year'>>;
  currentMonth: number;
  currentYear: number;
