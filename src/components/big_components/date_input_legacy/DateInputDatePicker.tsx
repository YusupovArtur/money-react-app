...
import DatePickerDaysField from 'components/big_components/date_input_legacy/date_picker_components/DatePickerDaysField';
import DatePickerMonthsField from 'components/big_components/date_input_legacy/date_picker_components/DatePickerMonthsField';
import DatePickerYearsField from 'components/big_components/date_input_legacy/date_picker_components/DatePickerYearsField';
import {
  DatePickerLabel,
  DatePickerCalendarButtons,
  DatePickerModalButtons,
} from 'components/big_components/date_input_legacy/date_picker_components/DatePickerParts';

import { getDatePickerDaysField } from 'components/big_components/date_input_legacy/date_picker_components/functions';
import { getDeviceType } from 'components/big_components/date_input_legacy/functions';
import { DATE_PICKER_CELL_SIZE } from 'components/big_components/date_input_legacy/constants';
import {
  incrementCalendar,
  decrementCalendar,
} from 'components/big_components/date_input_legacy/date_picker_components/functions';
