...
const EducationIcon: React.FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'Book':
...
const BookIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const BookFillIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const JournalIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HatGraduateIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
