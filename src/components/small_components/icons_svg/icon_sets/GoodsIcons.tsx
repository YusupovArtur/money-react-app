...
const GoodsIcon: React.FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'Cloth':
...
const ClothIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const ShoesIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
...
const WatchIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
