...
const ElectronicsIcon: React.FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'CPU':
...
const CPUIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const PhoneIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TelephoneIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const TelephoneFillIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const PCDisplayIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const DisplayIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const ControllerIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HeadsetIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
