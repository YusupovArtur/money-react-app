...
const HealthIcon: React.FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'Cross':
...
const MedecineCrossIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const CapsuleIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const CapsulePillIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HospitalIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HospitalFillIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const ToothIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const StethoscopeIconSVG: React.FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
