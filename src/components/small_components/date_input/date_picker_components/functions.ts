import { MIN_YEAR, MAX_YEAR } from 'components/small_components/date_input/constants';
import { datePickerDayCellPropsType } from 'components/small_components/date_input/types';
import { getIsDateCorrect } from 'components/small_components/date_input/functions';
