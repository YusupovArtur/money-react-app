...
export const TransactionsFilterMenuOptionLabel = <T extends keyof TransactionType>({
  fieldKey,
  optionKey,
  ...
  if (fieldKey === 'category') {
    return <CategoryShortInfo id={(optionKey as TransactionFieldCaptionKeyType<'category'>).categoryID} type={'transfer'} />;
  }
