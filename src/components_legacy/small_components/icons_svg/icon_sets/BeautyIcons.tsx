...
const ScissorsIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const ToothbruthIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
...
const CreamIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
...
const PomadeIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
...
const NailIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      width={iconSize}
      height={iconSize}
