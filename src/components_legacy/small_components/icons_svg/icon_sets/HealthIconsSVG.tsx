...
const MedecineCrossIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const CapsuleIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
const CapsulePillIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HospitalIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const HospitalFillIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const ToothIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
...
const StethoscopeIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
