...
export const BoxArrowLeftSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
...
export const GoogleIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
...
export const GithubIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
export const ThemeIcon: FC<{ iconName: string; iconSize: string }> = ({ iconName, iconSize }) => {
  switch (iconName) {
    case 'light':
...
const SunIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={iconSize}
...
const MoonIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
    <svg
      fill="currentColor"
      width={iconSize}
...
const ThemeAutoIconSVG: FC<{ iconSize: string }> = ({ iconSize }) => {
  return (
