...
import { FilteringCheckboxLabel } from 'widgets/TransactionsSortingFilteringMenu/components/Filtering/FilteringCheckboxInput/FilteringCheckboxLabel.tsx';
...
export const FilteringCheckboxOption = <T extends keyof TransactionType>({
  fieldKey,
  // option,
  optionKey,
  checked,
  ...
  return (
    <div className="form-check">
      ...
      <label className="form-check-label flex-grow-1 w-100 d-flex justify-content-start" htmlFor={id}>
        <FilteringCheckboxLabel fieldKey={fieldKey} optionKey={optionKey} />
      </label>
    </div>
  );
};
